...
test('calculates confidence for fresh entry', function () {
...
test('applies age factor to older entries', function () {
    $entry = Entry::factory()->create([
        'confidence' => 80,
        'status' => 'draft',
        'validation_date' => null,
...
test('applies validation boost to validated entries', function () {
    $entry = Entry::factory()->create([
        'confidence' => 80,
        'status' => 'validated',
        'validation_date' => now(),
...
test('caps confidence at 100', function () {
    $entry = Entry::factory()->create([
        'confidence' => 95,
        'status' => 'validated',
        'validation_date' => now(),
...
test('caps confidence at 0', function () {
    $entry = Entry::factory()->create([
        'confidence' => 10,
        'status' => 'draft',
        'validation_date' => null,
...
test('combines age factor and validation boost', function () {
    $entry = Entry::factory()->create([
        'confidence' => 80,
        'status' => 'validated',
        'validation_date' => now(),
...
test('updates entry confidence', function () {
    $entry = Entry::factory()->create([
        'confidence' => 80,
        'status' => 'validated',
        'validation_date' => now(),
...
test('validates entry and boosts confidence', function () {
    $entry = Entry::factory()->create([
        'confidence' => 80,
        'status' => 'draft',
        'validation_date' => null,
...
test('identifies stale entries not used in 90 days', function () {
...
test('identifies high confidence old entries needing review', function () {
    Entry::factory()->create([
        'confidence' => 85,
        'status' => 'draft',
