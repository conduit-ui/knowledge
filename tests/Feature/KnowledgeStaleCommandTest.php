...
test('lists entries not used in 90 days', function () {
...
test('lists entries never used and old', function () {
    Entry::factory()->create([
        'title' => 'Never Used',
        'last_used' => null,
...
test('displays high confidence old entries', function () {
    Entry::factory()->create([
...
test('suggests re-validation', function () {
    Entry::factory()->create([
        'last_used' => now()->subDays(91),
    ]);
...
test('displays no stale entries message', function () {
    Entry::factory()->create([
        'last_used' => now()->subDays(50),
    ]);
...
test('sorts by last used date', function () {
    Entry::factory()->create([
        'title' => 'Very Old',
...
test('displays entry id for validation', function () {
